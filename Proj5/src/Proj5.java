...
public class Proj5 {
	public static int size1 = 0; public static int size2 = 0;

	public static void main(String[] args) throws IOException {
		Scanner sc = new Scanner(System.in);
		System.out.print("Which file would you like to reference? ");
	 ...
	 * 
	 * parameter filename is the name of the file specified by the user to read in
	 * returns a double array containing all of the elements of the file
	 */
	public static int[][] readBoard(String filename) throws IOException {
		...
		try {
			...
			for (int count = 0; count < 2; count++) {
				if (count == 0) size1 = Integer.parseInt(s.nextLine());
				else if (count == 1) size2 = Integer.parseInt(s.nextLine());
			}
	 ...
	 * 
	 * parameter int[][] cells is used to put into a string
	 * a string containing all the elements of the array is returned
	 */
	public static String boardDisplay(int[][] cells) {
		String cellsArray = "";
		for (int i = 0; i < cells.length; i++) {
			for (int j = 0; j < cells[i].length; j++) {
				if (cells[i][j] == 0) cellsArray += "-";
				else if (cells[i][j] == 1) cellsArray += "*";
			}
	 ...
	 * 
	 * int[][] cells is the array being compared. int row is the row of the compared element. int col is the column of the compared element. 
	 * returns the amount of neighboring cells that have a 1 in them.
	 */
	 ...
	 * 
	 * int[][] cells is the array being accessed
	 * a new array with all of the changes is returned
	 */
